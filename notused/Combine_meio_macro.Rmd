...
ggplot(data=subset(mac_s, Cruise=="OR1_1096"|Cruise=="OR1_1114"|Cruise=="OR1_1126"), 
  ...
  theme_bw() %+replace% large #%+replace% dark
```
Only cruise 1096, 1114, 1126 can be merged
...
mei_s <- ldply(simu)
```
Only 1114, 1126 meiofauna can be merged with macrofauna
