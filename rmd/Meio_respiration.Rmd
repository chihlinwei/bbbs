...
Mass-specific meiofauna respiration rate was estimated from body mass and temperature using an empirical model, $log(R/M) = 8.3732 - 0.2073 * log(M) - 2766.0235 / T$, based on  a large database compilated for aquatic invertebrate respriation (<22000 measurements, >900 species, > 440 references) by Thomas Brey [linked phrase](http://www.thomas-brey.de/science/virtualhandbook/navlog/index.html). In the equation, R/M is the mass-specific respiration (J/J/day), M is individual body mass (J), and T is water temperature (K). 
