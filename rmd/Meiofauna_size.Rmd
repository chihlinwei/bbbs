---
title: "Meiofauna Size Spectrum & Biomass for OR1 1114, 1126, 1128, and 1132"
author: "Chih-Lin Wei"
date: "`r Sys.Date()`"
output: 
  html_document:
...
hab <- splitBy(~Habitat, data=subset(mei, Cruise=="OR1_1114"|Cruise=="OR1_1126"|Cruise=="OR1_1128"|Cruise=="OR1_1132"))
...
hab <- splitBy(~Habitat, data=subset(mei, (Cruise=="OR1_1114"|Cruise=="OR1_1126")&Wt>= 1e-03))
wt <- lapply(hab, FUN=function(x)x$Wt)
out <- lapply(wt, FUN=function(x)LBNbiom.method(x, binBreaks=bks))
nbss <- ldply(lapply(out, FUN=function(x)x$binVals), data.frame)
info <- ldply(strsplit(nbss$.id, split="[|]"))
...
```{r, fig.width=7, fig.height=5}
hab <- splitBy(~Cruise+Habitat, data=subset(mei, Cruise=="OR1_1114"|Cruise=="OR1_1126"|Cruise=="OR1_1128"|Cruise=="OR1_1132"))
wt <- lapply(hab, FUN=function(x)x$Wt)
out <- lapply(wt, FUN=function(x)LBNbiom.method(x, binBreaks=bks))
nbss <- ldply(lapply(out, FUN=function(x)x$binVals), data.frame)
info <- ldply(strsplit(nbss$.id, split="[|]"))
...
```{r, fig.width=7, fig.height=5}
# Only keep Wt > 1.220703e-04

hab <- splitBy(~Cruise+Habitat, data=subset(mei, (Cruise=="OR1_1114"|Cruise=="OR1_1126")&Wt>= 1e-03))
wt <- lapply(hab, FUN=function(x)x$Wt)
out <- lapply(wt, FUN=function(x)LBNbiom.method(x, binBreaks=bks))
nbss <- ldply(lapply(out, FUN=function(x)x$binVals), data.frame)
info <- ldply(strsplit(nbss$.id, split="[|]"))
...
hab <- splitBy(~Habitat+Depth.zone, data=subset(mei, Cruise=="OR1_1114"|Cruise=="OR1_1126"|Cruise=="OR1_1128"|Cruise=="OR1_1132"))
wt <- lapply(hab, FUN=function(x)x$Wt)
out <- lapply(wt, FUN=function(x)LBNbiom.method(x, binBreaks=bks))
nbss <- ldply(lapply(out, FUN=function(x)x$binVals), data.frame)
info <- ldply(strsplit(nbss$.id, split="[|]"))
...
hab <- splitBy(~Habitat+Depth.zone, data=subset(mei, (Cruise=="OR1_1114"|Cruise=="OR1_1126"|Cruise=="OR1_1128"|Cruise=="OR1_1132")&Wt>= 1e-03))
wt <- lapply(hab, FUN=function(x)x$Wt)
out <- lapply(wt, FUN=function(x)LBNbiom.method(x, binBreaks=bks))
nbss <- ldply(lapply(out, FUN=function(x)x$binVals), data.frame)
info <- ldply(strsplit(nbss$.id, split="[|]"))
...
wt <- wt[unlist(lapply(wt, length))>63]
out <- lapply(wt, FUN=MLE.method)
# size specutrum slope estimate by MLE
lapply(out, FUN=function(x)x[1:2])
plb <- ldply(lapply(out, FUN=function(x)x$PLB))
...
```{r, fig.width=8, fig.height=6}
hab <- splitBy(~Cruise+Habitat+Depth.zone, data=subset(mei, Cruise=="OR1_1114"|Cruise=="OR1_1126"|Cruise=="OR1_1128"|Cruise=="OR1_1132"))
wt <- lapply(hab, FUN=function(x)x$Wt)
out <- lapply(wt, FUN=function(x)LBNbiom.method(x, binBreaks=bks))
nbss <- ldply(lapply(out, FUN=function(x)x$binVals), data.frame)
info <- ldply(strsplit(nbss$.id, split="[|]"))
...
hab <- splitBy(~Cruise+Habitat+Depth.zone, data=subset(mei, (Cruise=="OR1_1114"|Cruise=="OR1_1126"|Cruise=="OR1_1128"|Cruise=="OR1_1132")&Wt>= 1e-03))
wt <- lapply(hab, FUN=function(x)x$Wt)
out <- lapply(wt, FUN=function(x)LBNbiom.method(x, binBreaks=bks))
nbss <- ldply(lapply(out, FUN=function(x)x$binVals), data.frame)
info <- ldply(strsplit(nbss$.id, split="[|]"))
...
wt <- wt[unlist(lapply(wt, length))>38]
out <- lapply(wt, FUN=MLE.method)
# size specutrum slope estimate by MLE
lapply(out, FUN=function(x)x[1:2])
plb <- ldply(lapply(out, FUN=function(x)x$PLB))
...
# NBSS and ISD by cruise, habitat and dominant taxa
## All size classes

```{r, fig.width=8, fig.height=6}
hab <- splitBy(~Cruise+Habitat+Category, data=subset(mei, (Cruise=="OR1_1114"|Cruise=="OR1_1126"|Cruise=="OR1_1128"|Cruise=="OR1_1132") & Category!="Others"))
wt <- lapply(hab, FUN=function(x)x$Wt)
...
hab <- splitBy(~Cruise+Habitat+Category, data=subset(mei, (Cruise=="OR1_1114"|Cruise=="OR1_1126"|Cruise=="OR1_1128"|Cruise=="OR1_1132") & Category!="Others" & Wt>= 1e-03))
wt <- lapply(hab, FUN=function(x)x$Wt)
out <- lapply(wt, FUN=LBNbiom.method)
nbss <- ldply(lapply(out, FUN=function(x)x$binVals), data.frame)
info <- ldply(strsplit(nbss$.id, split="[|]"))
...
wt <- wt[unlist(lapply(wt, length))>47]
out <- lapply(wt, FUN=MLE.method)
# size specutrum slope estimate by MLE
lapply(out, FUN=function(x)x[1:2])
plb <- ldply(lapply(out, FUN=function(x)x$PLB))
...
# Mean body size of meiofauna
## By cruise and habitat

```{r, fig.width=7, fig.height=5}
library(knitr)
dat.mean <- summaryBy(Wt+Depth~Region+Habitat+Cruise+Station, data=subset(mei, Condition=="C"), FUN=c(mean, sd, length))
...
```{r, fig.width=7, fig.height=5}
dat.mean <- summaryBy(Wt+Depth~Region+Habitat+Station, data=mei, FUN=c(mean, sd, length))
dat.mean$Wt.se <- dat.mean$Wt.sd/dat.mean$Wt.length^0.5
ggplot(data=dat.mean, 
       aes(x=Depth.mean, y=Wt.mean, 
           ymin=Wt.mean-Wt.se, ymax=Wt.mean+Wt.se,
