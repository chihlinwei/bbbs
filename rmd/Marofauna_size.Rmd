...
hab <- splitBy(~Habitat, data=subset(mac, Condition=="C"))
...
hab <- splitBy(~Habitat, data=subset(mac, Condition=="C" &Wt>7.812500e-03))
wt <- lapply(hab, FUN=function(x)x$Wt)
out <- lapply(wt, FUN=function(x)LBNbiom.method(x, binBreaks=bks))
nbss <- ldply(lapply(out, FUN=function(x)x$binVals), data.frame)
info <- ldply(strsplit(nbss$.id, split="[|]"))
...
hab <- splitBy(~Cruise+Habitat, data=subset(mac, Condition=="C"))
wt <- lapply(hab, FUN=function(x)x$Wt)
out <- lapply(wt, FUN=function(x)LBNbiom.method(x, binBreaks=bks))
nbss <- ldply(lapply(out, FUN=function(x)x$binVals), data.frame)
info <- ldply(strsplit(nbss$.id, split="[|]"))
...
hab <- splitBy(~Cruise+Habitat, data=subset(mac, Condition=="C" & Wt>7.812500e-03))
wt <- lapply(hab, FUN=function(x)x$Wt)
out <- lapply(wt, FUN=function(x)LBNbiom.method(x, binBreaks=bks))
nbss <- ldply(lapply(out, FUN=function(x)x$binVals), data.frame)
info <- ldply(strsplit(nbss$.id, split="[|]"))
...
hab <- splitBy(~Habitat+Depth.zone, data=subset(mac, Condition=="C"))
wt <- lapply(hab, FUN=function(x)x$Wt)
out <- lapply(wt, FUN=function(x)LBNbiom.method(x, binBreaks=bks))
nbss <- ldply(lapply(out, FUN=function(x)x$binVals), data.frame)
info <- ldply(strsplit(nbss$.id, split="[|]"))
...
hab <- splitBy(~Habitat+Depth.zone, data=subset(mac, Condition=="C" & Wt>7.812500e-03))
wt <- lapply(hab, FUN=function(x)x$Wt)
out <- lapply(wt, FUN=function(x)LBNbiom.method(x, binBreaks=bks))
nbss <- ldply(lapply(out, FUN=function(x)x$binVals), data.frame)
info <- ldply(strsplit(nbss$.id, split="[|]"))
...
```{r, fig.width=10, fig.height=8}
hab <- splitBy(~Cruise+Habitat+Depth.zone, data=subset(mac, Condition=="C"))
wt <- lapply(hab, FUN=function(x)x$Wt)
out <- lapply(wt, FUN=function(x)LBNbiom.method(x, binBreaks=bks))
nbss <- ldply(lapply(out, FUN=function(x)x$binVals), data.frame)
info <- ldply(strsplit(nbss$.id, split="[|]"))
...
hab <- splitBy(~Habitat+Taxon, data=subset(mac, Condition=="C"))
wt <- lapply(hab, FUN=function(x)x$Wt)
out <- lapply(wt, FUN=function(x)LBNbiom.method(x, binBreaks=bks))
nbss <- ldply(lapply(out, FUN=function(x)x$binVals), data.frame)
info <- ldply(strsplit(nbss$.id, split="[|]"))
...
```{r, fig.width=7, fig.height=5}
library(knitr)
dat.mean <- summaryBy(Wt+Depth~Region+Habitat+Cruise+Station, data=subset(mac, Condition=="C"), FUN=c(mean, sd, length))

ggplot(data=dat.mean, 
       aes(x=Depth.mean, y=Wt.mean, 
           ymin=Wt.mean-Wt.sd, ymax=Wt.mean+Wt.sd,
...
out <- dat.mean[, c("Region", "Habitat", "Cruise", "Station", "Depth.mean", "Wt.length", "Wt.mean", "Wt.sd")]
...
out <- dat.mean[, c("Region", "Habitat", "Station", "Depth.mean", "Wt.length", "Wt.mean", "Wt.sd")]
