...
# This function is modified from recommend.r by Chih-Lin Wei to re-produce Fig 6 in Edwards et al. (2017)
# PLB.bMLE = b estimated by MLE
# PLB.MLE.bConf = 95% confidence interval of b
# PLB = fit values for normalized biomass size spectrum and rank biomass plot
MLE.method<-
  function(x){
