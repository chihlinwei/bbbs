...
out <- out[, c("Habitat", "Cruise", "Station", "Depth.mean", "annual.PtoB.mean", "productionW.mean", "productionW.se", "productionJ.mean", "productionJ.se", "productionC.mean", "productionC.se", "Depth.length")]

names(out) <- c("Habitat", "Cruise", "Station", "Depth", "annual.PtoB", "productionW", "productionW.se", "productionJ", "productionJ.se", "productionC", "productionC.se", "n")
