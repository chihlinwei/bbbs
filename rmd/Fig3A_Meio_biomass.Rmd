...
abun$Density <- abun$Abundance/(pi*(2.8/2)^2/10000)
...
Meiofauna density of each subsample were averaged by core (i.e., average of three subsamples) before further statistical tests. We used Generalized Least Squares (GLS) modeling to examine the effects of habitat (canyon vs. slope), depth, and sampling time (Cruise 1114 vs. 1126) on the mean meiofauna density.
...
dat.sum$Biomass <- dat.sum$Wt/(pi*(2.8/2)^2/10000)
