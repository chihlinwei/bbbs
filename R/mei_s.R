...
#' equation, \eqn{L*W^2*C}, where L = length, W = width, C = taxon specific conversion factors (Nematoda C = 0.53, Harpacticoida C = 0.4, Ostracoda C = 0.45,
#' Polychaeteta C = 0.53, Oligochaeta C = 0.53, Tanaidacea C = 0.4, Isopoda C = 0.23) from Warwick & Gee (1984), Feller & Warwick (1988). The biovolume was
#' converted to soft-body wet mass assuming a density of 1.13 mg mm^3 (Gerlach et al., 1985). The length and width of nematodes were only measured for 100
#' randomly selected speciments from each samples.Because not all nematode specimens were measured for their sizes, the size distribution of nematodes
#' (from 100 random individuals) were scaled to the total observed abundance by re-sampling the observed size measurements (with replacement).
#' @docType data
#' @keywords datasets
