...
#' converted to soft-body wet mass assuming a density of 1.13 mg mm^3 (Gerlach et al., 1985).Because polychaetes and Ophiuroids are easy to break off;
#' therefore, the size data of complete polychaete and Ophiuroid specimens were re-sampled to match to the total numbers of individual in a sample
#' (e.g., polychaete with head and ophiurids with disk).
#' @docType data
#' @keywords datasets
